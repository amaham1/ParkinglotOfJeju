...
class MainViewModel : ViewModel() {
    private var getData = ParkinglotParse()
    init {
        getData.ParkinglotParser()
    }
    //파싱용
    ...
    inner class ParkinglotParse {
        ...
        fun ParkinglotParser() {
            Log.d("1ee", "불림")
            object : AsyncTask<Void?, Void?, List<ParkinglotInfoItem>>() {
